  ...
  return (
        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8'>
            ...
            <div className='flex gap-1 items-center mb-6'>
                <div className='flex items-center gap-1 cursor-pointer'>
                    ...
                    <div className='w-4 h-4 bg-red-500 -ml-2 rounded-full opacity-100 hover:opacity-75
                    transition-opacity'></div>
                </div>
                <span className='text-xl font-medium ml-1 '>The Next Design </span>
             </div>
            <p className='text-gray-600 mb-6 md:w-3/4'> The cony warned the Little Blind Text. that where it came from it would have been
            rewritten a thousand timesi</p>
    ...
    <div className='border-t border-gray-200 mt-12 pt-8'></div>
        <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
            ...
            <p className='text-600 text-sm '>Created By Md Rayhan</p>
        </div>
        </div>
    </footer>
  )

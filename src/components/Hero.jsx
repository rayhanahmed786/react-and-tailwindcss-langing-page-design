  ...
  return (
    <section id="home" className='container mx-auto flex flex-col md:flex-row justify-between items-center pt-44 pb-6 px-4 sm:px-6 lg:px-8'>
        ...
        <div className='flex items-center gap-2 bg-gray-50 w-fit px-4 py-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer group'>
            ...
            <span className='text-sm font-medium'> jump start your crowd</span>

        </div>

        <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold leading-tight'>We boost the growth for
            <span className='text-blue-600 relative inline-block'>Startup to
            Fortune 500
            <span className='absolute bottom-0 left-0 w-full h-0.5 bg-blue-200/60'></span>
            </span> companes
            <span className='inline-block ml-2 animate-pluse'>🕓</span>
            </h1>
            <p className='text-gray-600 text-lg md:text-xl max-w'> Get the most accurate leads, sales people training and
conversions, toois and more - all Within tne same one
billing</p>

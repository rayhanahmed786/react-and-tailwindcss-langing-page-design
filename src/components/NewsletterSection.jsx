    ...
    <section className='container mx-auto px-4 sm:px-6 lg:px-8 py-16'>
       ...
       <div className='relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12'>
        ...
        <div className='text-white max-w-lg text-center md:text-left'>
            ...
            <p className='text-blue-100 text-sm sm:text-base'>tha countrine Mokalia and Conconantial there live the blind texts.</p>
        </div>
        ...
        <div className='flex flex-col sm:flex-row sm:gap-0'>
            ...
            <button className='w-full sm:w-auto cursor-pointer bg-green-500 text-white px-6 sm:px-8 py-3 sm:py-4 
